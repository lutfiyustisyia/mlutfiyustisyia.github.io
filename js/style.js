...
$(document).scroll(function() 
{
  let scrollDistance = $(this).scrollTop();
    let a = true;
  if (scrollDistance > 1000 && a) 
  {
     $("#pro-1").animate({width: '90%'}, 50);
     $("#pro-2").animate({width: '89%'}, 50);
     $("#pro-3").animate({width: '91%'}, 50);
     $("#pro-4").animate({width: '92%'}, 50);

     $("#pro-5").animate({width: '97%'}, 50);
     $("#pro-6").animate({width: '85%'}, 50);
     $("#pro-7").animate({width: '78%'}, 50);
     $("#pro-8").animate({width: '92%'}, 50);

     $("#pro-9").animate({width: '84%'}, 50);
